...
class UpperObjects(pygame.sprite.Sprite):
    def __init__(self, *groups):
        ...
        for _ in range(num_objects):
            ...
            y_position = random.uniform(top_fourth_start, configs.SCREEN_HEIGHT / 4 )  # NEW
            x_position = random.uniform(configs.SCREEN_WIDTH + 800, configs.SCREEN_WIDTH - 200 ) # new
