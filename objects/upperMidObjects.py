...
class UpperMiddleObjects(pygame.sprite.Sprite):
    def __init__(self, *groups):
        ...
        upper_middle_start = configs.SCREEN_HEIGHT *  (1/4)
        ...
        for _ in range(num_objects):
            ...
            y_position = random.uniform(upper_middle_start, configs.SCREEN_HEIGHT * (2/4) )  # NEW
            x_position = random.uniform(configs.SCREEN_WIDTH + 1000, configs.SCREEN_WIDTH) # new
