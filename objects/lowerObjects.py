...
class LowerObjects(pygame.sprite.Sprite):
    def __init__(self, *groups):
        ...
        bottom_fourth_start = configs.SCREEN_HEIGHT * 3/4    # NEW
        ...
        for _ in range(num_objects):
            ...
            y_position = random.uniform(bottom_fourth_start, configs.SCREEN_HEIGHT) #NEW
            x_position = random.uniform(configs.SCREEN_WIDTH +1000, configs.SCREEN_WIDTH - 300) #400
